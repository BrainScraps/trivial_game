  ...
  namespace :deploy do
    ...
    namespace :db do
      ...
      task :setup, :except => { :no_release => true } do
        ...
        dbname = Capistrano::CLI.ui.ask("What would you like to name your application's db?>>>")
        ...
        base: &base
          ...
          timeout: 5000
          username: isaac
          password: #{Capistrano::CLI.ui.ask("Enter postgresql password>>>")}
    ...
    after "deploy:db:symlink", "deploy:db:create_db"
